...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_26595 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_26595(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_26597 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_26597(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_26604 = (function (reader,ch){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_26604(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_26605 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_26605(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_26606 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_26606(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_26609 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_26609(reader);
}
});
...
var G__26667 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__26668 = s.append(c);
c = G__26667;
s = G__26668;
continue;
}
