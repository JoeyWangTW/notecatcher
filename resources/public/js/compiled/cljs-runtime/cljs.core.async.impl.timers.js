...
var i_28958 = (0);
while(true){
if((i_28958 < arr.length)){
(arr[i_28958] = null);

var G__28959 = (i_28958 + (1));
i_28958 = G__28959;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_28983 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_28983[i]));
} else {
x__$2.forward.push((((i < links_28983.length))?(links_28983[i]):null));
}

if((i < links_28983.length)){
(links_28983[i] = x__$2);
} else {
links_28983.push(x__$2);
}
...
var i_28989 = (0);
while(true){
if((i_28989 <= self__.level)){
var links_28994 = (update[i_28989]).forward;
if((x__$1 === (((i_28989 < links_28994.length))?(links_28994[i_28989]):null))){
(links_28994[i_28989] = (x__$1.forward[i_28989]));

var G__28995 = (i_28989 + (1));
i_28989 = G__28995;
continue;
} else {
var G__28996 = (i_28989 + (1));
i_28989 = G__28996;
continue;
}
} else {
...
if(cljs.core.truth_(nx)){
var G__29013 = nx;
var G__29014 = (level__$1 - (1));
x = G__29013;
level__$1 = G__29014;
continue;
} else {
var G__29015 = x;
var G__29016 = (level__$1 - (1));
x = G__29015;
level__$1 = G__29016;
continue;
}
