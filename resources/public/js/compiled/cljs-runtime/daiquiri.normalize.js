...
if(((((cljs.core.set_QMARK_(class$)) || (cljs.core.sequential_QMARK_(class$)))) && (cljs.core.every_QMARK_((function (p1__35326_SHARP_){
return (((p1__35326_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__35326_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__35333,new cljs.core.Keyword(null,"class","class",-2030961996),daiquiri.normalize.normalize_class);
} else {
return G__35333;
}
});
...
var len__4818__auto___35406 = arguments.length;
var i__4819__auto___35407 = (0);
while(true){
if((i__4819__auto___35407 < len__4818__auto___35406)){
args__4824__auto__.push((arguments[i__4819__auto___35407]));

var G__35408 = (i__4819__auto___35407 + (1));
i__4819__auto___35407 = G__35408;
continue;
} else {
}
break;
...
var G__35340 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_(classes)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__35340,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec(classes));
} else {
return G__35340;
}
} else {
...
/** @this {Function} */
(daiquiri.normalize.merge_with_class.cljs$lang$applyTo = (function (seq35335){
var self__4806__auto__ = this;
return self__4806__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq35335));
}));
...
var vec__35371 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():((cljs.core.contains_QMARK_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null),cljs.core.ffirst(matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(matches),cljs.core.rest(matches)], null)
));
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35371,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35371,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,daiquiri.normalize.strip_css(cljs.core.some((function (p1__35369_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__35369_SHARP_))){
return p1__35369_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$1((function (p1__35370_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__35370_SHARP_))){
return daiquiri.normalize.strip_css(p1__35370_SHARP_);
} else {
return null;
}
})),names)], null);
 ...
 */
daiquiri.normalize.element = (function daiquiri$normalize$element(p__35391){
var vec__35392 = p__35391;
var seq__35393 = cljs.core.seq(vec__35392);
var first__35394 = cljs.core.first(seq__35393);
var seq__35393__$1 = cljs.core.next(seq__35393);
var tag = first__35394;
var content = seq__35393__$1;
...
var vec__35397 = daiquiri.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35397,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35397,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35397,(2),null);
var tag_attrs = (function (){var G__35400 = cljs.core.PersistentArrayMap.EMPTY;
var G__35400__$1 = (((!(cljs.core.empty_QMARK_(id))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__35400,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__35400);
if((!(cljs.core.empty_QMARK_(class$)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__35400__$1,new cljs.core.Keyword(null,"class","class",-2030961996),class$);
} else {
return G__35400__$1;
}
})();
