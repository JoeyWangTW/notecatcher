...
var vec__35285 = cljs.core.name(k).split("-");
var seq__35286 = cljs.core.seq(vec__35285);
var first__35287 = cljs.core.first(seq__35286);
var seq__35286__$1 = cljs.core.next(seq__35286);
var first_word = first__35287;
var words = seq__35286__$1;
...
var or__4212__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(daiquiri.util.attrs_cache),k);
...
return cljs.core.persistent_BANG_(cljs.core.reduce_kv((function (p1__35299_SHARP_,p2__35300_SHARP_,p3__35301_SHARP_){
return cljs.core.assoc_BANG_.cljs$core$IFn$_invoke$arity$3(p1__35299_SHARP_,daiquiri.util.camel_case(p2__35300_SHARP_),p3__35301_SHARP_);
...
var m__$1 = cljs.core.persistent_BANG_(cljs.core.reduce_kv((function (p1__35309_SHARP_,p2__35310_SHARP_,p3__35311_SHARP_){
return cljs.core.assoc_BANG_.cljs$core$IFn$_invoke$arity$3(p1__35309_SHARP_,daiquiri.util.camel_case(p2__35310_SHARP_),p3__35311_SHARP_);
}),cljs.core.transient$(cljs.core.PersistentArrayMap.EMPTY),m));
var G__35319 = m__$1;
if(cljs.core.map_QMARK_(new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m__$1))){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__35319,new cljs.core.Keyword(null,"style","style",-496642736),daiquiri.util.camel_case_keys);
} else {
return G__35319;
}
} else {
