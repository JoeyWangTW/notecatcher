...
if(((((cljs.core.set_QMARK_(class$)) || (cljs.core.sequential_QMARK_(class$)))) && (cljs.core.every_QMARK_((function (p1__5858_SHARP_){
return (((p1__5858_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__5858_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__5859,new cljs.core.Keyword(null,"class","class",-2030961996),daiquiri.normalize.normalize_class);
} else {
return G__5859;
}
});
...
var len__4818__auto___5876 = arguments.length;
var i__4819__auto___5877 = (0);
while(true){
if((i__4819__auto___5877 < len__4818__auto___5876)){
args__4824__auto__.push((arguments[i__4819__auto___5877]));

var G__5878 = (i__4819__auto___5877 + (1));
i__4819__auto___5877 = G__5878;
continue;
} else {
}
break;
...
var G__5861 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_(classes)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__5861,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec(classes));
} else {
return G__5861;
}
} else {
...
/** @this {Function} */
(daiquiri.normalize.merge_with_class.cljs$lang$applyTo = (function (seq5860){
var self__4806__auto__ = this;
return self__4806__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq5860));
}));
...
var vec__5864 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():((cljs.core.contains_QMARK_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null),cljs.core.ffirst(matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(matches),cljs.core.rest(matches)], null)
));
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5864,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5864,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,daiquiri.normalize.strip_css(cljs.core.some((function (p1__5862_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__5862_SHARP_))){
return p1__5862_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$1((function (p1__5863_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__5863_SHARP_))){
return daiquiri.normalize.strip_css(p1__5863_SHARP_);
} else {
return null;
}
})),names)], null);
 ...
 */
daiquiri.normalize.element = (function daiquiri$normalize$element(p__5868){
var vec__5869 = p__5868;
var seq__5870 = cljs.core.seq(vec__5869);
var first__5871 = cljs.core.first(seq__5870);
var seq__5870__$1 = cljs.core.next(seq__5870);
var tag = first__5871;
var content = seq__5870__$1;
...
var vec__5872 = daiquiri.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5872,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5872,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5872,(2),null);
var tag_attrs = (function (){var G__5875 = cljs.core.PersistentArrayMap.EMPTY;
var G__5875__$1 = (((!(cljs.core.empty_QMARK_(id))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__5875,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__5875);
if((!(cljs.core.empty_QMARK_(class$)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__5875__$1,new cljs.core.Keyword(null,"class","class",-2030961996),class$);
} else {
return G__5875__$1;
}
})();
