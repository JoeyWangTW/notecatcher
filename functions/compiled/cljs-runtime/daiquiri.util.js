...
var vec__5795 = cljs.core.name(k).split("-");
var seq__5796 = cljs.core.seq(vec__5795);
var first__5797 = cljs.core.first(seq__5796);
var seq__5796__$1 = cljs.core.next(seq__5796);
var first_word = first__5797;
var words = seq__5796__$1;
...
return cljs.core.persistent_BANG_(cljs.core.reduce_kv((function (p1__5820_SHARP_,p2__5821_SHARP_,p3__5822_SHARP_){
return cljs.core.assoc_BANG_.cljs$core$IFn$_invoke$arity$3(p1__5820_SHARP_,daiquiri.util.camel_case(p2__5821_SHARP_),p3__5822_SHARP_);
...
var m__$1 = cljs.core.persistent_BANG_(cljs.core.reduce_kv((function (p1__5824_SHARP_,p2__5825_SHARP_,p3__5826_SHARP_){
return cljs.core.assoc_BANG_.cljs$core$IFn$_invoke$arity$3(p1__5824_SHARP_,daiquiri.util.camel_case(p2__5825_SHARP_),p3__5826_SHARP_);
}),cljs.core.transient$(cljs.core.PersistentArrayMap.EMPTY),m));
var G__5827 = m__$1;
if(cljs.core.map_QMARK_(new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m__$1))){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__5827,new cljs.core.Keyword(null,"style","style",-496642736),daiquiri.util.camel_case_keys);
} else {
return G__5827;
}
} else {
